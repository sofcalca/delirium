...
from text_generator.cli import cli
from text_generator_tests.acceptances.fixtures import clone_fixture
...
class MainTest(unittest.TestCase):
    ...
    def test_main_exit_with_1_as_error_code_if_action_fails(self):
        ...
        # Acts
        result = runner.invoke(cli, ['start_delirium_from', '--name', 'fabien'])
